  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 hidden lg:block">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.92 }}
        aria-label="Chat on WhatsApp (+91 63639 35011)"
        title="Chat on WhatsApp (+91 63639 35011)"
        className="relative flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] shadow-2xl shadow-[#25D366]/50 border-2 border-white/30 transition-all cursor-pointer"
      >
        <svg
          viewBox="0 0 24 24"
          width="32"
